    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      {[
        { 
          name: "Mark Brook", 
          img: coach3, 
          description: "Specializes in Hatha Yoga and meditation techniques with over 10 years of experience."
        },
        { 
          name: "Sarah Henderson", 
          img: coach3, 
          description: "An expert in Vinyasa Yoga, known for her dynamic flow classes and mindfulness practices." 
        },
        { 
          name: "George Hump", 
          img: coach3, 
          description: "A certified Ashtanga instructor with a passion for teaching strength and flexibility techniques."
        },
        { 
          name: "Victor Hump", 
          img: coach4, 
          description: "Focusing on restorative and therapeutic yoga, Victor helps students improve posture and relaxation."
        },
      ].map((coach, index) => (
        <div key={index} className="text-center" data-aos="fade-up">
          ...
          <p className="text-gray-700 mt-2">{coach.description}</p>
        </div>
      ))}
    </div>
  </div>
